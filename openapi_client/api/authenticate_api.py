...
class AuthenticateApi:
    ...
    def get_access_token(
        ...
        Authenticates client application using pre-provisioned access/secret keys.  **Token Expiry:** 15 minutes (900 seconds) **Rate Limit:** Not applied to this endpoint  **Headers Required in Subsequent Calls:** `Authorization: Bearer {accessToken}` 
