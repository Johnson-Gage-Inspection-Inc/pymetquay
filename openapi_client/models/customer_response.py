...
class CustomerResponse(BaseModel):
    ...
    """ # noqa: E501
    id: Optional[StrictInt] = Field(default=None, description="Unique Metquay ID of the customer")
    ...
    company_code: Optional[StrictStr] = Field(default=None, description="Unique identifier for the customer", alias="companyCode")
    is_inactive: Optional[StrictBool] = Field(default=None, description="Customer status - false for active, true for inactive", alias="isInactive")
    company_name: Optional[StrictStr] = Field(default=None, description="Legal name of the customer organization", alias="companyName")
    ...
    activate_alerts: Optional[StrictBool] = Field(default=None, description="Alert notification status", alias="activateAlerts")
    workspace_code: Optional[StrictStr] = Field(default=None, description="Workspace code", alias="workspaceCode")
    has_billing_address: Optional[StrictBool] = Field(default=None, description="Indicates if billing address exists", alias="hasBillingAddress")
    ...
    has_shipping_address: Optional[StrictBool] = Field(default=None, description="Indicates if shipping address exists", alias="hasShippingAddress")
