...
class InstrumentCategoryRequest(BaseModel):
    """
    Request payload for creating or updating an instrument category
    """ # noqa: E501
    name: StrictStr = Field(description="Instrument category name - must be unique across the system")
    description: Optional[StrictStr] = Field(default=None, description="Detailed description of the instrument category")
