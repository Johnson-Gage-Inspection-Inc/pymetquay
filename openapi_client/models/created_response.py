...
class CreatedResponse(BaseModel):
    ...
    metquay_id: StrictInt = Field(
        description="Unique numeric ID of the created resource", alias="metquayId"
    )
    __properties: ClassVar[List[str]] = ["metquayId"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({"metquayId": obj.get("metquayId")})
        return _obj
