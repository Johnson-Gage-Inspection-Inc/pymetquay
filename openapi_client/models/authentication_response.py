...
class AuthenticationResponse(BaseModel):
    ...
    """ # noqa: E501
    access_token: StrictStr = Field(description="JWT access token (valid for 15 minutes)", alias="accessToken")
    token_type: StrictStr = Field(description="Token type - always \"bearer\"", alias="tokenType")
    expires_in: Optional[StrictInt] = Field(default=None, description="Token validity period in seconds", alias="expiresIn")
