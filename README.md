...
```sh
pip install git+https://github.com/Johnson-Gage-Inspection-Inc/GIT_REPO_ID.git
```
(you may need to run `pip` with root permission: `sudo pip install git+https://github.com/Johnson-Gage-Inspection-Inc/GIT_REPO_ID.git`)
