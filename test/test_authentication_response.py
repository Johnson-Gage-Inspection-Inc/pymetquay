...
class TestAuthenticationResponse:
    ...
    def test_construction_required_only(self):
        ...
        assert obj.access_token == 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIxMjM0NTY3ODkwIiwibmFtZSI6IkpvaG4gRG9lIiwiaWF0IjoxNTE2MjM5MDIyLCJleHAiOjE1MTYyMzk5MjJ9.7H-bj0gF6cDxQqYqWlQqYqWlQqYqWlQqYqWlQqYqWlQqY'
