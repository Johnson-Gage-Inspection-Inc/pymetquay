...
class TestInstrumentcategoriesApi(unittest.TestCase):
    """InstrumentcategoriesApi unit test stubs"""

    def setUp(self) -> None:
        self.api = InstrumentcategoriesApi()

    def tearDown(self) -> None:
        pass

    def test_create_instrument_category(self) -> None:
        """Test case for create_instrument_category

        Create a new instrument category
        """
        pass

    def test_delete_instrument_category(self) -> None:
        """Test case for delete_instrument_category

        Delete an instrument category
        """
        pass

    def test_update_instrument_category(self) -> None:
        """Test case for update_instrument_category
