...
class TestCustomerRequest:
    ...
    def test_construction_required_only(self):
        ...
        assert obj.company_name == "Metquay Inc."
    ...
    def test_optional_fields_default_to_none(self):
        ...
        obj = CustomerRequest(**self._REQUIRED_KWARGS)
        assert obj.parent_company_code is None
        assert obj.company_code is None
        assert obj.email is None
        assert obj.website is None
        assert obj.payment_method is None
        ...
        assert obj.billing_addr1 is None
        assert obj.billing_addr2 is None
        assert obj.billing_city is None
        assert obj.billing_state is None
        assert obj.billing_zip is None
        assert obj.billing_country is None
        assert obj.billing_phone1 is None
        assert obj.billing_phone2 is None
        assert obj.shipping_addr1 is None
        assert obj.shipping_addr2 is None
        assert obj.shipping_city is None
        assert obj.shipping_state is None
        assert obj.shipping_zip is None
        assert obj.shipping_country is None
        ...
        assert obj.opening_balance is None
    ...
    def test_from_dict_none_returns_none(self):
        ...
        assert CustomerRequest.from_dict(None) is None
