...
class TestResponseShapes:
    ...
    def test_customers_response_shape(self, client):
        try:
            resp: ApiResponse = (  # type: ignore[type-arg]
                client._customers_api.get_customers_with_http_info(
                    limit=1,
                )
            )
    ...
    def test_instruments_response_shape(self, client):
        try:
            resp: ApiResponse = (  # type: ignore[type-arg]
                client._instruments_api.get_customer_instruments_with_http_info(
                    limit=1,
                )
            )
        except ApiException as e:
    ...
    def test_works_response_shape(self, client):
        try:
            resp: ApiResponse = (  # type: ignore[type-arg]
                client._works_api.get_works_with_http_info(
                    limit=1,
                )
            )
        except ApiException as e:
